...
public class QuaHanActivity extends AppCompatActivity {
    ...
    private void addControl(){
        txtNoBook = findViewById(R.id.QuaHanNoBook);
        imgNoBook = findViewById(R.id.QuaHanimg);
        rclView = findViewById(R.id.QuaHanRecyclerView);
    ...
    private void callData(){
        String url = Constant.serverLink + "/TaiLieu/LayDanhSachTaiLieuQuaHan";
